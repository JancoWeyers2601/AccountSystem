...
public class AccountTransactionDto implements Serializable {
    ...
    @ApiModelProperty(
            ...
            name = "TransactionId",
            notes = "Name of the Id of AccountTransaction",
    ...
    @ApiModelProperty(
            ...
            value = "Member ID",
            name = "MemberID",
            notes = "Name of ID of Member",
            dataType = "java.lang.Long",
            example = "3",                              /*Any number as ID number*/
            allowEmptyValue = false,
            required = true
    )
    ...
    @ApiModelProperty(
            ...
            example = "54",                              /*Any number as ID number*/
            allowEmptyValue = false,
            required = true
    )
